...
function startSimulation(mode) {
    ...
    behavioralPsychologyEngine = new BehavioralPsychologyEngine(echo, currentSession);
...
function generateComprehensiveReport() {
    ...
    return {
        ...
        behavioral: behavioralPsychologyEngine ? behavioralPsychologyEngine.generateReport() : null,
