...
import EthicalLoanSummary from "./ethical/EthicalLoanSummary"; // Import the new summary component
...
const Phase2EthicalWebsite: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (understandsTerms) {
      // Transition to the summary step instead of finishing
  ...
  // Handlers for the summary component
  const handleConfirm = () => {
        ...
        return (
          <div className="p-8 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              We believe in clear, upfront terms. No hidden fees, no surprises.
              This calculator is based on the federal Payday Alternative Loan
              (PAL) model.
            </p>
                ...
                <div className="pt-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      ...
                      >
                        I understand the total cost and repayment schedule of my
                        loan.
                      </label>
                    </div>
                  </div>
