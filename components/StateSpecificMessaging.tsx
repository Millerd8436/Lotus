      ...
      predatory_messaging: [
        {
          type: "urgency",
          message:
            "🚨 TEXAS EXCLUSIVE: Get up to $1,800 in minutes! No waiting periods!",
          context: "Homepage banner - exploits lack of cooling-off period",
        },
        {
          type: "targeting",
          message:
            "Texans deserve financial freedom! When banks say no, we say YES!",
          context: "Appeals to state pride to mask exploitation",
        },
        {
          type: "minimization",
          message:
            "Simple $45 fee* (*actual APR up to 664% but who's counting?)",
          context:
            "Minimizes devastating APR with asterisk buried in fine print",
        },
        {
          type: "deception",
          message:
            "No credit check! Perfect for hardworking Texans between paychecks!",
    ...
    CA: {
      ...
      predatory_messaging: [
        ...
        },
        {
          type: "targeting",
          message:
            "Golden State residents: Bridge the gap to your next paycheck!",
      ...
      regulatory_warnings: [
        {
          type: "required",
          message:
            "A payday loan is a high-cost loan. Consider alternatives like credit union loans.",
          font_size: "12px",
          prominence: 6,
        },
        {
      ...
      predatory_messaging: [
        {
          type: "deception",
          message:
            "New York residents: Get approved for alternative funding options!",
          context: 'Circumvents ban with vague "alternative" language',
        },
        {
          type: "targeting",
          message:
            "Empire State Emergency Cash - When life happens, we're here!",
      ...
      regulatory_warnings: [
        {
          type: "required",
          message:
            "WARNING: Payday loans are illegal in New York. Interest rates above 25% may constitute criminal usury.",
          font_size: "14px",
          prominence: 9,
        },
        {
          type: "required",
          message:
            "This may be an illegal loan. Contact the NY Attorney General if charged excessive fees.",
          font_size: "12px",
          prominence: 8,
        },
      ],
    ...
    FL: {
      ...
      regulatory_warnings: [
        ...
        },
        {
          type: "required",
          message:
            "Deferred presentment providers are regulated by the Florida Office of Financial Regulation.",
          font_size: "10px",
          prominence: 5,
        },
      ],
      ...
      predatory_messaging: [
        {
          type: "urgency",
          message:
            "🎯 MISSOURI EXCLUSIVE: Highest approval rates in the nation!",
      ...
      predatory_messaging: [
        {
          type: "deception",
          message:
            "Montana residents: Check your eligibility for emergency funding!",
      ...
      regulatory_warnings: [
        {
          type: "required",
          message:
            "Montana law caps interest rates at 36% APR. Higher rates may be illegal.",
          font_size: "14px",
          prominence: 9,
        },
      ],
        ...
        <>
          ...
          <div
            style={{
              ...
              marginBottom: "2rem",
              boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)",
              border: `3px solid ${getComplianceColor(currentRegulation.compliance_level || "moderate")}`,
            }}
          >
            <div
              style={{
              ...
              <div>
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        width: `${(currentRegulation.enforcement_strength || 5) * 10}%`,
                        height: "100%",
                        background:
