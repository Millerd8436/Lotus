      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: "1.5rem", fontWeight: 800, color: "#2e7d32" }}
            >
          ...
          >
            ...
            <div
              style={{ fontSize: "1.5rem", fontWeight: 800, color: "#1976d2" }}
            >
              ${ethicalLoan.fee}
            </div>
          </div>
          ...
          >
            ...
            <div
              style={{ fontSize: "1.5rem", fontWeight: 800, color: "#f57c00" }}
            >
          ...
          >
            ...
            <div
              style={{ fontSize: "1.5rem", fontWeight: 800, color: "#7b1fa2" }}
            >
              {ethicalLoan.apr}%
            </div>
          </div>
          ...
          >
            {alternatives.map((alt, index) => (
              <div
                ...
                style={{
                  background:
                    alt.name === "Traditional Payday Loan" ? "#ffebee" : "#fff",
                  padding: "1.5rem",
                  borderRadius: "12px",
                  border:
