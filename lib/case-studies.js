...
export class CaseStudyDatabase {
  ...
  loadCriminalCases() {
    return {
      scott_tucker_amg_services: {
        ...
        scheme_details: {
          ...
          deceptive_practices: [
            ...
            },
            {
              ...
              reality:
                "Tribes had no operational control or meaningful ownership",
            },
          ],
        },
        ...
        enforcement_outcome: {
          criminal_conviction:
            "RICO conspiracy and truth-in-lending violations",
        ...
        victim_testimonies: [
          {
            ...
            testimony:
              '"I thought it was a 3-year loan. After 4 years of payments, I still owed more than I borrowed."',
          },
          {
            ...
            testimony:
              '"The payments seemed manageable at first, but they never seemed to reduce the balance."',
          },
        ],
      },
        ...
        victim_testimonies: [
          {
            ...
            story: {
              ...
              impact_quote:
                '"I thought I was getting help, but I was signing up for financial slavery"',
            },
          },
          {
        ...
        internal_practices_revealed: [
          {
            ...
            description:
              "Explicit metrics for keeping customers in debt cycles",
            quotas: {
            ...
            training_materials:
              '"A customer who pays off their loan is a lost customer"',
          },
          {
            practice: "Vulnerability targeting",
            description:
              "Marketing specifically designed to target financial desperation",
            tactics: [
        ...
        internal_communications: [
          {
            ...
            sender: "Regional VP",
            content_excerpt:
              '"Store 247 continues to underperform on customer retention. Remember, our business model depends on repeat customers, not one-time borrowers."',
          },
          {
            training_slide: "Customer Psychology 101",
            content:
              '"Desperate customers make quick decisions. Use time pressure and scarcity to prevent comparison shopping."',
          },
        ],
      },
        ...
        common_findings: [
          {
            ...
            description:
              "Banks failed to adequately oversee payday lending partners",
          ...
          },
          {
            ...
            description:
              "Disproportionate complaints related to bank-partnered payday loans",
            metrics:
              "15x higher complaint rate than traditional banking products",
          },
          {
            finding: "Reputational risk concerns",
            frequency: "78% of examinations",
            description:
              "Examiner concerns about association with predatory lending",
  ...
  getRelevantCaseStudy(simulationParameters) {
    const { loanAmount, borrowerIncome, state, lenderType } =
  ...
  generateVictimProfile(caseData, simulationData) {
    return {
      ...
      progression_parallel: this.mapProgressionParallel(
        caseData,
        simulationData,
      ),
      outcome_probability: this.calculateOutcomeProbability(
        caseData,
        simulationData,
      ),
      intervention_points: this.identifyInterventionPoints(
        caseData,
        simulationData,
      ),
    };
...
export class ConsumerHarmMetrics {
      ...
      social_harm: {
        community_impact: {
          local_economic_extraction: {
            ...
            community_types_affected:
              "Low-income neighborhoods disproportionately",
          },
          ...
          social_services_burden: {
            ...
            cost_attribution:
              "Estimated 12-18% increase in social services demand",
          },
        },
      },
    };
  ...
  calculateTotalHarm(borrowerProfile, loanHistory, outcomes) {
    ...
    harm.total_quantified =
      harm.financial.direct + harm.psychological.quantified;
    harm.total_estimated =
      harm.total_quantified + harm.financial.indirect + harm.social.estimated;
  ...
  calculateFinancialHarm(borrowerProfile, loanHistory) {
    const baseline_cost =
      loanHistory.principal * 0.36 * (loanHistory.total_days / 365);
    ...
    return {
      ...
      indirect: this.estimateIndirectFinancialHarm(
        borrowerProfile,
        loanHistory,
      ),
      breakdown: {
        ...
        opportunity_cost: this.estimateOpportunityCost(
          borrowerProfile,
          loanHistory,
        ),
      },
    ...
    return {
      debt_trap_progression: {
        stage_1_initial_loan: {
          borrower_voice:
            "I just need $300 to fix my car. I'll pay it back when I get paid next week.",
          industry_voice:
            "Another customer successfully onboarded. Initial loan amount optimized for rollover probability.",
          reality_voice:
            "This borrower has a 76% chance of being unable to repay in full, triggering our revenue-generating rollover cycle.",
          educational_voice:
            "Notice how the lender frames this as helping, while internally viewing it as customer acquisition for a debt trap.",
        },

        stage_2_first_rollover: {
          borrower_voice:
            "I can't pay the full $345 right now, but I can pay the $45 fee to extend it.",
          industry_voice:
            "Perfect. First rollover achieved. Customer now demonstrating expected payment behavior.",
          reality_voice:
            "The borrower just paid 15% interest for a two-week extension. Annualized, that's 390% APR.",
          educational_voice:
            "This is the trap activating. The borrower thinks they're managing the debt, but they're actually feeding it.",
        },

        stage_3_multiple_rollovers: {
          borrower_voice:
            "I've paid $135 in fees but still owe the original $300. This doesn't make sense.",
          industry_voice:
            "Customer showing signs of rollover fatigue. Prepare retention offers.",
          reality_voice:
            "The borrower has paid 45% of the principal in fees alone, with no reduction in debt.",
          educational_voice:
            "Classic debt trap mechanics. The borrower is now paying more in fees than many people pay for rent.",
        },
      },
      ...
      multiloan_escalation: {
        second_lender_approach: {
          borrower_voice:
            "Maybe I can get a loan from another place to pay off the first one.",
          industry_voice:
            "Lead generation system activated. Customer shopping behavior detected.",
          reality_voice:
            "The borrower is about to double their debt burden while thinking they're solving the problem.",
          educational_voice:
            "This is how single loans become multiple loans. The borrower seeks relief but finds deeper entrapment.",
        },
      },
    };
  }
