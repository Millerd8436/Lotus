...
export const simulateDebtCycle = (initialAmount, fee, rolloverCount, state = 'GEN') => {
  const cycles = [];
...
export const STATE_REGULATIONS = {
  'AL': { maxAPR: 456, minTermDays: 10, allowRollover: true, maxRollovers: 1, description: 'Alabama - Limited regulation' },
  'AK': { maxAPR: 435, minTermDays: 14, allowRollover: true, maxRollovers: 2, description: 'Alaska - Moderate regulation' },
  'AZ': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Arizona - Strong consumer protection' },
  'AR': { maxAPR: 17, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Arkansas - Very restrictive' },
  'CA': { maxAPR: 36, minTermDays: 31, allowRollover: false, maxRollovers: 0, description: 'California - Strong consumer protection' },
  'CO': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Colorado - Reformed regulations' },
  'CT': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Connecticut - Strong protection' },
  'DE': { maxAPR: 521, minTermDays: 7, allowRollover: true, maxRollovers: 4, description: 'Delaware - Minimal regulation' },
  'FL': { maxAPR: 304, minTermDays: 7, allowRollover: true, maxRollovers: 3, description: 'Florida - Moderate regulation' },
  'GA': { maxAPR: 16, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Georgia - Very restrictive' },
  'HI': { maxAPR: 459, minTermDays: 14, allowRollover: true, maxRollovers: 1, description: 'Hawaii - Limited regulation' },
  'ID': { maxAPR: 652, minTermDays: 7, allowRollover: true, maxRollovers: 999, description: 'Idaho - Very permissive' },
  'IL': { maxAPR: 404, minTermDays: 13, allowRollover: true, maxRollovers: 2, description: 'Illinois - Moderate regulation' },
  'IN': { maxAPR: 391, minTermDays: 14, allowRollover: true, maxRollovers: 2, description: 'Indiana - Moderate regulation' },
  'IA': { maxAPR: 433, minTermDays: 7, allowRollover: true, maxRollovers: 2, description: 'Iowa - Limited regulation' },
  'KS': { maxAPR: 391, minTermDays: 7, allowRollover: true, maxRollovers: 3, description: 'Kansas - Moderate regulation' },
  'KY': { maxAPR: 459, minTermDays: 14, allowRollover: true, maxRollovers: 2, description: 'Kentucky - Limited regulation' },
  'LA': { maxAPR: 780, minTermDays: 7, allowRollover: true, maxRollovers: 4, description: 'Louisiana - Very permissive' },
  'ME': { maxAPR: 30, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Maine - Strong protection' },
  'MD': { maxAPR: 33, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Maryland - Strong protection' },
  'MA': { maxAPR: 23, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Massachusetts - Very restrictive' },
  'MI': { maxAPR: 369, minTermDays: 7, allowRollover: true, maxRollovers: 1, description: 'Michigan - Moderate regulation' },
  'MN': { maxAPR: 390, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Minnesota - Reformed regulations' },
  'MS': { maxAPR: 572, minTermDays: 7, allowRollover: true, maxRollovers: 5, description: 'Mississippi - Very permissive' },
  'MO': { maxAPR: 1955, minTermDays: 14, allowRollover: true, maxRollovers: 6, description: 'Missouri - Extremely permissive' },
  'MT': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Montana - Reformed regulations' },
  'NE': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Nebraska - Reformed regulations' },
  'NV': { maxAPR: 652, minTermDays: 7, allowRollover: true, maxRollovers: 4, description: 'Nevada - Very permissive' },
  'NH': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'New Hampshire - Reformed regulations' },
  'NJ': { maxAPR: 30, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'New Jersey - Strong protection' },
  'NM': { maxAPR: 175, minTermDays: 14, allowRollover: true, maxRollovers: 2, description: 'New Mexico - Moderate regulation' },
  'NY': { maxAPR: 25, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'New York - Very restrictive' },
  'NC': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'North Carolina - Strong protection' },
  'ND': { maxAPR: 520, minTermDays: 7, allowRollover: true, maxRollovers: 3, description: 'North Dakota - Permissive' },
  'OH': { maxAPR: 391, minTermDays: 7, allowRollover: true, maxRollovers: 4, description: 'Ohio - Moderate regulation' },
  'OK': { maxAPR: 390, minTermDays: 12, allowRollover: true, maxRollovers: 2, description: 'Oklahoma - Moderate regulation' },
  'OR': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Oregon - Reformed regulations' },
  'PA': { maxAPR: 24, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Pennsylvania - Very restrictive' },
  'RI': { maxAPR: 260, minTermDays: 13, allowRollover: true, maxRollovers: 2, description: 'Rhode Island - Moderate regulation' },
  'SC': { maxAPR: 391, minTermDays: 31, allowRollover: true, maxRollovers: 1, description: 'South Carolina - Moderate regulation' },
  'SD': { maxAPR: 36, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'South Dakota - Reformed regulations' },
  'TN': { maxAPR: 460, minTermDays: 15, allowRollover: true, maxRollovers: 2, description: 'Tennessee - Limited regulation' },
  'TX': { maxAPR: 664, minTermDays: 7, allowRollover: true, maxRollovers: 3, description: 'Texas - Very permissive' },
  'UT': { maxAPR: 547, minTermDays: 7, allowRollover: true, maxRollovers: 10, description: 'Utah - Extremely permissive' },
  'VT': { maxAPR: 18, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Vermont - Very restrictive' },
  'VA': { maxAPR: 391, minTermDays: 7, allowRollover: true, maxRollovers: 2, description: 'Virginia - Moderate regulation' },
  'WA': { maxAPR: 391, minTermDays: 31, allowRollover: true, maxRollovers: 1, description: 'Washington - Moderate regulation' },
  'WV': { maxAPR: 309, minTermDays: 15, allowRollover: true, maxRollovers: 1, description: 'West Virginia - Moderate regulation' },
  'WI': { maxAPR: 565, minTermDays: 7, allowRollover: true, maxRollovers: 4, description: 'Wisconsin - Permissive' },
  'WY': { maxAPR: 780, minTermDays: 14, allowRollover: true, maxRollovers: 4, description: 'Wyoming - Very permissive' },
  'DC': { maxAPR: 24, minTermDays: 30, allowRollover: false, maxRollovers: 0, description: 'Washington DC - Very restrictive' },
  'GEN': { maxAPR: 400, minTermDays: 14, allowRollover: true, maxRollovers: 3, description: 'General - Typical payday loan state' }
};
...
export const calculateCoercionScore = (violations, trapTypes, timeUnderPressure = 0) => {
  let score = 0;
...
export const getCoercionLevel = (score) => {
  if (score >= 80) return { level: 'EXTREME', description: 'Severe psychological manipulation' };
  if (score >= 60) return { level: 'HIGH', description: 'Significant coercion present' };
  if (score >= 40) return { level: 'MODERATE', description: 'Multiple manipulation tactics' };
  if (score >= 20) return { level: 'LOW', description: 'Some autonomy violations' };
...
export const QUIZ_QUESTIONS = [
  {
    ...
    correct: 1,
    explanation: 'APR (Annual Percentage Rate) shows the true yearly cost of borrowing, including fees and interest, making it essential for comparing loans.'
  },
  {
    id: 'rollover_trap',
    ...
    correct: 1,
    explanation: 'A rollover means paying only the fee to extend the loan, which traps borrowers in debt cycles since the principal is never reduced.'
  },
  {
    id: 'dark_patterns',
    ...
    correct: 2,
    explanation: 'Pre-checking boxes manufactures consent without explicit user choice, which is a classic dark pattern manipulation.'
  },
  {
    ...
    correct: 2,
    explanation: 'Missouri allows APRs up to 1955%, making it one of the most permissive states for predatory lending.'
  }
];
...
export const generateComparisonMetrics = (exploitativeSession, ethicalSession) => {
  ...
  return {
    ...
    savingsPercentage: ((exploitativeSession.totalCost - ethicalSession.totalCost) / exploitativeSession.totalCost) * 100
  };
};
...
export const USURY_LOOPHOLES = {
  FlatFee: {
    ...
    implementation: (principal, termDays) => {
      ...
      return { fee, hiddenAPR, userSees: `$${fee} fee`, realityIs: `${hiddenAPR.toFixed(0)}% APR` };
    }
  },
  ...
  CSOBrokerage: {
    ...
    mechanism: 'Frame as brokerage fee connecting borrower to third-party lender',
    effectiveness: 88,
    vulnerableStates: ['TX', 'OH', 'NV', 'UT', 'WI', 'KS', 'AL', 'MS', 'LA', 'SC']
  },
  ...
  TribalCharter: {
    ...
    examples: [
      { lender: 'Western Sky', tribe: 'Cheyenne River Sioux', apr: 342, outcome: 'Shut down by regulators' },
      { lender: 'CashCall', tribe: 'Lac Vieux Desert Band', apr: 135, outcome: '$16M settlement' }
    ]
  },
  ...
  InterstateBanking: {
    ...
    mechanism: 'Partner with banks in permissive states to override borrower state caps',
    effectiveness: 65,
...
export class RolloverTrapEngine {
  ...
  initializePsychologyTactics() {
    return {
      lossAversion: {
        message: "Don't lose your loan! Roll over to keep your access to emergency cash.",
        effectiveness: 0.82,
      ...
      falseAltruism: {
        message: "We're here to help! Rolling over prevents damage to your credit.",
        effectiveness: 0.68,
      ...
      sunkCostFallacy: {
        message: "You've already invested in this loan. Don't waste your progress!",
        effectiveness: 0.77,
  ...
  generateEchoMessage(data) {
    return `You paid $${data.feeCharged} to roll over your $${data.principalUnchanged} loan. ` +
...
export class ACHDebitSimulator {
  ...
  simulateAutomaticDebit(borrower, loan, bankAccount) {
    ...
    const debitResult = {
      ...
      overdraftTriggered: bankAccount.balance < debitAmount && bankAccount.overdraftEnabled,
      consequences: []
    };
...
export const HARM_METRICS = {
  centerForResponsibleLending: {
    ...
    findings: {
      ...
      profitFromRepeatUsersPct: 0.90, // 90% of revenue
  ...
  cfpbStudy2013: {
    ...
    findings: {
      ...
      borrowersWithMore5Loans: 0.80, // 80%
      borrowersWithMore10Loans: 0.60, // 60%
      defaultRate: 0.20, // 20% eventually default
      renewalWithin14Days: 0.80 // 80% of borrowers renew within 14 days
    },
...
export class EchoModeNarrator {
  ...
  echo(userAction, context) {
    ...
    const message = echoMessages[userAction] || this.generateGenericEcho(context);
  ...
  generateLoanEcho(context) {
    ...
    return `You just agreed to pay ${apr.toFixed(0)}% APR (${formatCurrency(fee)} on ${formatCurrency(amount)}). ` +
  ...
  generateRolloverEcho(context) {
    ...
    return `Rollover #${rolloverCount}: You paid ${formatCurrency(totalFees)} in fees but still owe ` +
  ...
  generateFeesEcho(context) {
    ...
    return `You've now paid ${feeRatio.toFixed(0)}% of the original loan amount in fees alone. ` +
           `You've been trapped for ${timeTrapped} days. The meter is still running.`;
  }
  
  generateACHEcho(context) {
    return `You just gave them direct access to your bank account. They'll take their money first, ` +
  ...
  generateUpsellEcho(context) {
    ...
    return `"Congratulations, you qualify!" Translation: "You're trapped enough to be profitable, ` +
...
export const REGULATORY_BYPASS_MECHANISMS = {
  minnesotaModel: {
    ...
    implementation: 'Issue new loan immediately after payoff to circumvent rollover bans',
    effectiveness: 0.85,
...
export const DARK_PATTERN_LIBRARY = {
  temporalDiscounting: {
    ...
    psychologicalBasis: 'Humans heavily discount future costs when under immediate stress',
    implementation: {
  ...
  anchoringManipulation: {
    ...
    psychologicalBasis: 'First numerical information heavily influences subsequent judgments',
    implementation: {
    ...
    effectiveness: 0.78,
    variations: ['Price anchoring', 'Time anchoring', 'Qualification anchoring']
  },
  ...
  socialProofManufacturing: {
    ...
    psychologicalBasis: 'People follow perceived majority behavior under uncertainty',
    implementation: {
  ...
  cognitiveLoadOverload: {
    ...
    psychologicalBasis: 'Mental overload leads to System 1 (fast, emotional) decision making',
    implementation: {
  ...
  authorityBiasExploitation: {
    ...
    psychologicalBasis: 'People defer to perceived authority figures and institutions',
    implementation: {
...
export class MultiloanDependencyEngine {
  ...
  calculateLoanFrequency(history) {
    ...
    const timeSpan = new Date(history[history.length - 1].date) - new Date(history[0].date);
  ...
  analyzeLoanTiming(history) {
    ...
    const avgDaysBetween = payoffToNewLoanDays.reduce((a, b) => a + b, 0) / payoffToNewLoanDays.length;
  ...
  generateUpsellSequence(borrower, dependencyScore) {
    ...
    const risk = dependencyScore < 30 ? 'lowRisk' : 
                 dependencyScore < 70 ? 'mediumRisk' : 'highRisk';
  ...
  countRollovers(history) {
    return history.reduce((total, loan) => total + (loan.rolloverCount || 0), 0);
  }
  ...
  identifyDependencyIndicators(factors) {
    ...
    if (factors.alternatingLenders > 0.3) indicators.push('Lender shopping behavior');
  ...
  buildJurisdictionMap() {
    return {
      permissive: {
        ...
        characteristics: ['High APR caps', 'Minimal regulation', 'CSO loopholes'],
        avgMaxAPR: 550
      },
      
      moderate: {
        states: ['FL', 'OH', 'IN', 'TN', 'VA', 'SC'],
        characteristics: ['Some regulation', 'Database tracking', 'Limited rollovers'],
        avgMaxAPR: 350
      },
      ...
      tribal: {
        ...
        characteristics: ['Sovereign immunity claims', 'Federal oversight only'],
        avgMaxAPR: 400
      },
...
export class BehavioralScoringEngine {
  ...
  calculateVulnerabilityScore(userSession, applicationData) {
    ...
    score += this.scoringModel.hesitationPatterns[userSession.hesitationLevel] || 0;
  ...
  initializeTrapTypes() {
    return {
      ...
      creditDamageTrap: {
        ...
        recoveryYears: 3.5,
        alternativesRemaining: ['more_payday_loans', 'pawn_shops', 'loan_sharks']
      }
    };
  }
  ...
  loadVictimProfiles() {
    return {
      ...
      military: {
        ...
        vulnerabilities: ['Financial inexperience', 'Deployment stress', 'Family pressure'],
      ...
      elderly: {
        ...
        vulnerabilities: ['Technology confusion', 'Isolation', 'Cognitive decline'],
        targeting: ['Direct mail', 'Phone calls', 'Storefronts'],
        harmProfile: 'Retirement savings depletion, essential needs deprivation'
      }
    };
  }
  ...
  simulateDebtProgression(initialLoan, borrowerProfile) {
    ...
    for (let cycle = 1; cycle <= 9; cycle++) {
      ...
      progression.push({
        ...
        cumulativeAPR: (totalFeesPaid / totalPrincipalBorrowed) * (365 / timeInTrap) * 100,
    ...
    return {
      ...
      summary: {
        ...
        totalFeesPaid,
        totalPrincipalBorrowed,
        effectiveAPR: (totalFeesPaid / totalPrincipalBorrowed) * (365 / timeInTrap) * 100,
        costAsPercentOfIncome: (totalFeesPaid / borrowerProfile.annualIncome) * 100,
        recoveryEstimateMonths: Math.ceil(totalFeesPaid / (borrowerProfile.monthlyIncome * 0.1))
      }
    };
  }
